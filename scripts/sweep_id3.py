...
def _build_report(
    ...
    # §7 Anything else
    # -----------------------------------------------------------------
    lines.append("## 7. Anything else I noticed (the user asked me to flag)")
    lines.append("")
    lines.append(
    ...
    lines.append(
        ...
        "(severity: medium). Already feasible with the helpers added in "
        "this prompt; do it in Prompt E2 before the slides go to print."
    )
    lines.append("")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--report",
        type=Path,
        default=Path("_audits/sweep_results.md"),
